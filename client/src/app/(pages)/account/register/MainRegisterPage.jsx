      ...
      {!isLogin && (
        <>
          <div className="bg-[url('/login.png')] h-screen bg-cover bg-center bg-no-repeat">
            <div className="flex justify-center xl:justify-between gap-[400px] xl:px-[150px] pt-[30px]">
              ...
              <div className="w-full sm:w-[650px] bg-white mx-[30px] sm:mx-0 px-[30px] sm:px-[70px] py-[50px] sm:py-[40px] rounded-[20px] shadow-2xl">
                <div className="text-[#505050] font-semibold text-[24px] sm:text-[36px] mb-[30px] sm:mb-[30px]">REGISTER</div>
                <RegisterForm />
