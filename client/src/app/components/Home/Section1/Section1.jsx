      ...
      <div className="flex items-center gap-[10px] sm:gap-[30px] lg:gap-[50px]">
        <div className="w-[60%]">
          ...
          <div className="flex gap-[10px] lg:gap-[20px] items-center" data-aos="fade-up" data-aos-delay="300">
            <Link href={login ? "/dashboard" : "/account/login"} className="bg-[#505050] hover:bg-[#505050bd] text-white px-[10px] sm:px-[20px] py-[10px] rounded-[8px] text-[10px] lg:text-[20px] font-[600]">
              {login ? "Dashboard" : "Getting Started"}
            </Link>
            <Link href="https://en.wikipedia.org/wiki/Internet_of_things" target="blank" className="hidden sm:block text-[10px] lg:text-[20px] font-[600] text-[#505050] hover:bg-[#5e5e5e33] px-[20px] py-[10px] rounded-[8px]">About IoT</Link>
          </div>
        </div>
