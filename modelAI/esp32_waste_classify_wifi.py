...
# Link MongoDB - Tự lấy từ DNS SRV/TXT (khi bạn chỉ có SRV URI): chương trình có thể tự gọi lấy do wifi không chặn
...
collection = MongoDBHandler2(MONGO_URL)

# ============================= Cấu hình Camera ======================
ESP32_URL = 'http://192.168.137.53/cam-mid.jpg'   # có thể là /capture hoặc /jpg tùy firmware

# ============================= Label product ==========================
LABELS = ['battery','biological','cardboard','clothes','glass',
          'metal','paper','plastic','shoes','trash']
ID_GROUPS = {
    "1": {"biological","plastic"},
