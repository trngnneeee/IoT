...
async function getBinFill(args) {
    ...
    try {
        ...
        const fillPct = doc.fillPct !== undefined ? doc.fillPct : (0, queries_1.computeFillPct)(doc);
        return {
            bin: args.bin,
